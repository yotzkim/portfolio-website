...
const EmailSection = () => {
  ...
  return (
    <section
      id="contact"
      className="grid mx-24 md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative"
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          I&apos;m always open to chat and looking for internship opportunities for Summer 2025! Whether you have a question or just want to say hi, I&apos;ll
